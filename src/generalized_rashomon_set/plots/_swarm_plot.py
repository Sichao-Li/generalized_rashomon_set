...
def swarm_plot_FIS(explainer, interest_of_pairs, vname=None, plot_all=False, threshold=None, boxplot=False, save=False, absolute=False,
                   suffix=None):
    '''
...
def swarm_plot_FIS_multiple(*explainers, interest_of_pairs=None, vname=None, plot_all=False, threshold=None, boxplot=False, save=False, absolute=False,
                   suffix=None):
